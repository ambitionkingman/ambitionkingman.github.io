...
(function () {
  ...
  window.needShareButton = function (elem, options) {
    ...
    root.getImage = function () {
      ...
      // check querySelector existance for old browsers
      if (document.querySelector) {
        content = document.querySelector("meta[property=\"og:img\"]") ||
                  document.querySelector("meta[name=\"twitter:img\"]");
        if (content) {
    ...
    root.share = {
      ...
      "wechat": function (el) {
        ...
        if (img) {
          ...
          img.src = imgSrc;
          img.alt = "loading wechat img...";
          img.setAttribute("class", "need-share-wechat-code-img");
      ...
      "douban": function (el) {
        ...
        var url = "https://www.douban.com/share/service?name=" +
          ...
          "&img=" + encodeURIComponent(myoptions.image);
        root.popup(url);
      },
      "qqzone": function (el) {
        var myoptions = getOptions(el);
      ...
      "vkontakte": function (el) {
        ...
        url += "&img=" + encodeURIComponent(myoptions.image);
        url += "&noparse=true";
    ...
    document.addEventListener("click", function (event) {
      ...
      if (!closest(event.target, ".need-share-button-opened")) {
        if (openedEl) {
          ...
          // hide wechat code img when close the dropdown.
          if (openedEl.querySelector(".need-share-wechat-code-img")) {
            openedEl.querySelector(".need-share-wechat-code-img").remove();
          }
        } else {
